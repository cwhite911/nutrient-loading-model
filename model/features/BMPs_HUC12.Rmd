...
con <- dbConnect(PostgreSQL(), dbname = "postgres", user = "postgres",
                 host = "postgis",
                 port="5432")
```
### Test Connection
...
# spplot(hu12_building_footprints_df, col.regions=rev(brewer.pal(7,'Spectral')), cuts=6, main="HUC12 Buildings in 30m Stream Buffer", scales = list(draw = TRUE))
...
```{r nlcd, echo=TRUE}
spplot(hu12_building_footprints_df, c("total_buildings"),
 cols="year_built",
 col.regions=rev(brewer.pal(7,'Spectral')),
 cuts=6, main="Number of Buildings in 30m Stream Buffer by HUC12",
