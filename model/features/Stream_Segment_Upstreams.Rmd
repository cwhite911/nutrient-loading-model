...
for(year in nwalt_years) {
  
}


rgrass7::execGRASS("r.stats", parameters = list(input="subwatersheds,nwalt_landuse_1974@wrri10m", separator=",", output="nwalt_subwatershed_1974.csv"), flags = c("a","c","l", "n", "overwrite"))
rgrass7::execGRASS("r.stats", parameters = list(input="subwatersheds,nwalt_landuse_1982@wrri10m", separator=",", output="nwalt_subwatershed_1982.csv"), flags = c("a","c","l", "n", "overwrite"))
rgrass7::execGRASS("r.stats", parameters = list(input="subwatersheds,nwalt_landuse_1992@wrri10m", separator=",", output="nwalt_subwatershed_1992.csv"), flags = c("a","c","l", "n", "overwrite"))
rgrass7::execGRASS("r.stats", parameters = list(input="subwatersheds,nwalt_landuse_2002@wrri10m", separator=",", output="nwalt_subwatershed_2002.csv"), flags = c("a","c","l", "n", "overwrite"))
rgrass7::execGRASS("r.stats", parameters = list(input="subwatersheds,nwalt_landuse_2012@wrri10m", separator=",", output="nwalt_subwatershed_2012.csv"), flags = c("a","c","l", "n", "overwrite"))

df_nwalt_subwatershed_1974 <- read.table(
  "nwalt_subwatershed_1974.csv",
  sep=",", 
  header=FALSE,
  col.names=c("site_num", "site_id","landclass","unk1", "area_sqm", "cell_count"))

df_nwalt_subwatershed_1982 <- read.table(
  "nwalt_subwatershed_1982.csv",
  sep=",", 
  header=FALSE,
  col.names=c("site_num", "site_id","landclass","unk1", "area_sqm", "cell_count"))
...
df_nwalt_subwatershed_2002 <- read.table(
  "nwalt_subwatershed_2002.csv",
  sep=",", 
  header=FALSE,
  col.names=c("site_num", "site_id","landclass","unk1", "area_sqm", "cell_count"))
...
df_nwalt_subwatershed_1974$year <- as.Date("01/01/1974", format="%m/%d/%Y")
df_nwalt_subwatershed_1982$year <- as.Date("01/01/1982", format="%m/%d/%Y")
df_nwalt_subwatershed_1992$year <- as.Date("01/01/1992", format="%m/%d/%Y")
df_nwalt_subwatershed_2002$year <- as.Date("01/01/2002", format="%m/%d/%Y")
df_nwalt_subwatershed_2012$year <- as.Date("01/01/2012", format="%m/%d/%Y")
# Merge each year into a signle dataframe
df_nwalt_subwatershed <- bind_rows(
  df_nwalt_subwatershed_1974,
  df_nwalt_subwatershed_1982,
  df_nwalt_subwatershed_1992,
  df_nwalt_subwatershed_2002,
  df_nwalt_subwatershed_2012
)
